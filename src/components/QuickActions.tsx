    ...
    <div className="grid grid-cols-2 gap-3 max-w-2xl w-full">
      {QUICK_ACTIONS.map((action, i) => (
        <button
          ...
          className="text-left p-4 rounded-xl border border-gray-200 hover:border-[#F7941D] hover:bg-orange-50 transition-all text-sm text-gray-600 hover:text-[#1B3A5C] cursor-pointer"
        >
          {action}
        </button>
      ))}
