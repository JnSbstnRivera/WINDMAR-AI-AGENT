...
export function WelcomeScreen({ onSend, disabled, onTypingChange, onAttach, onEmail }: Props) {
  return (
    <div className="relative flex-1 flex flex-col items-center px-4 pt-2 pb-6 sm:pb-8">
      {/* El fondo "mundo" (esfera + estrellas) lo pinta <WorldBackground/> a nivel raíz */}
      ...
      <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#1B3A5C] dark:text-white mb-1 text-center tracking-tight" style={{ textShadow: '0 1px 16px rgba(43,92,190,0.35)' }}>
        Agente Windmar Home
      </h1>

      <p className="text-gray-500 dark:text-gray-300 text-xs sm:text-sm text-center max-w-md mb-1 px-2">
